...
use KukulkanPopolvux\CoinspaidApiPhp\Response;
...
class Builder
{
    ...
    {
        $this->domain = $domain ?? self::DOMAINS_DEFAULT[$this->getEnvironment()];
     ...
     *
     * @param \KukulkanPopolvux\CoinspaidApiPhp\Response $response
     * @return self
     */
