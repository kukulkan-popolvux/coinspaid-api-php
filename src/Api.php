...
use KukulkanPopolvux\CoinspaidApiPhp\{Basic, Response};

final class Api extends Basic
{
    public function __construct(string $apiKey = '', string $secretKey = '', string $environment = 'prod')
    {
        parent::__construct($apiKey, $secretKey, $environment);
    }
    /**
     * Pathname "Ping"
     *
     ...
     * @link https://docs.cryptoprocessing.com/api-documentation/api-reference#ping
     *
     * @return \KukulkanPopolvux\CoinspaidApiPhp\Response|null
     */
    ...
    {
        return $this->setMethod('post')->setPathName(self::LIST_CURRENCIES)->addParameter('visible', (int) $visible, ($visible !== null))->request();
    }
